...
u8 ataReadStatusReg(int chn);
u8 ataReadErrorReg(int chn);

void ataWriteByte(int chn, u8 addr, u8 data);

u16 ataReadu16(int chn);
void ataWriteu16(int chn, u16 data);

void ata_read_buffer(int chn, u32 *dst);
void ata_write_buffer(int chn, u32 *src);
